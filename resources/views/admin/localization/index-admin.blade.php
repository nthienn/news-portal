...
@section('title', __('admin.Admin Localization'))
    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">{{ __('admin.Admin Localization') }}</div>
            </div>
        </div>
        ...
        <div class="section-body">
            <div class="card card-primary">
                <div class="card-header">
                    <h4>{{ __('admin.Admin Localization') }}</h4>
                </div>
                <div class="card-body">
                            ...
                            <div class="tab-pane fade show {{ $loop->index === 0 ? 'active' : '' }}"
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped" id="table-{{ $language->language }}">
                                        ...
                                        <tbody>
                                            @php
                                                $translatedValues = trans('admin', [], $language->language);
                                            @endphp
